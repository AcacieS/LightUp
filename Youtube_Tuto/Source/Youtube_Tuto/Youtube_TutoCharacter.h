...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "ThrowPreview", meta = (AllowPrivateAccess = "true"))
	UInstancedStaticMeshComponent *TrajectoryMesh;

	UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "ThrowPreview")
